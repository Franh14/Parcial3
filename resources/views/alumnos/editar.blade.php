...
@section('content')
    <section class="content-header">
        <center>
            <h1 class="text-primary p-5">Editar Usuario</h1>
            ...
            <div class="row">
                ...
                <input type="text" name="name" class="form-control-plaintext" id="name" placeholder="Ejemplo" value="{{ old('name') }}">
            ...
            <div class="row">
                <div class="form-group col-sm-6">
                <button type="submit" class="btn btn-success"><i class="fa fa-edit"></i>Editar Usuario</button>
                </div>
                </div>
            </form>
        </center>        
